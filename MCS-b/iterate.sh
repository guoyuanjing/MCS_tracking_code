...
# for year in $( seq 2001 2003)

for year in $(seq 2001 2020)
do 

FILENAMESTRING='gpmmm_cn_'${year}'03'
cd $PFAD
...
cd /disk1/guoyj/MCS-tracking/iterative_raincell_tracking/GPM-b-221K-pre5-5000-a-a/output/
...
FILENAMESTRING='gpmmm_cn_'${year}'05'
cd $PFAD
${PFAD}/irt_objects_release.x ${FILENAMESTRING}
${PFAD}/irt_tracks_release.x ${FILENAMESTRING}
${PFAD}/irt_tracklinks_release.x ${FILENAMESTRING}
...
FILENAMESTRING='gpmmm_cn_'${year}'07'
cd $PFAD
${PFAD}/irt_objects_release.x ${FILENAMESTRING}
${PFAD}/irt_tracks_release.x ${FILENAMESTRING}
${PFAD}/irt_tracklinks_release.x ${FILENAMESTRING}
...
FILENAMESTRING='gpmmm_cn_'${year}'08'
cd $PFAD
${PFAD}/irt_objects_release.x ${FILENAMESTRING}
${PFAD}/irt_tracks_release.x ${FILENAMESTRING}
${PFAD}/irt_tracklinks_release.x ${FILENAMESTRING}
...
FILENAMESTRING='gpmmm_cn_'${year}'09'
cd $PFAD
${PFAD}/irt_objects_release.x ${FILENAMESTRING}
${PFAD}/irt_tracks_release.x ${FILENAMESTRING}
${PFAD}/irt_tracklinks_release.x ${FILENAMESTRING}
